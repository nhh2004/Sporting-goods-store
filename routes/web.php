...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('users/register', [App\Http\Controllers\Admin\Users\LoginController::class, 'register'])->name('register');
        Route::post('users/register', [App\Http\Controllers\Admin\Users\LoginController::class, 'storeRegistration'])->name('register.store');
        Route::post('/admin/users/login/store', [App\Http\Controllers\Admin\Users\LoginController::class, 'store'])->name('admin.login.store');
        Route::get('/admin/users/register', [App\Http\Controllers\Admin\Users\LoginController::class, 'register'])->name('admin.register');
        ...
        Route::get('/payment/execute', 'PayPalController@executePayment')->name('payment.execute');
        Route::get('/paypal/checkout', [YourController::class, 'checkout'])->name('paypal.checkout');
        Route::get('/example', [YourController::class, 'methodName']);
