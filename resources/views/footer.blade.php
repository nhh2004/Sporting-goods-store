        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    If you have any questions? Let us know at the store on the 2nd floor,
                    FPT APTECH College, or call us at (+84) 0987654321
                </p>
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        <h4 class="mtext-105 cl2 js-name-detail p-b-14" id="quick-name">
                            Men's Kiprun Light running shorts - Black
                        </h4>
                ...
                <div class="row no-gutters" style="margin-top: -30px">
                    <div class="col-lg-12 offset-lg-1 col-12">
                        ...
                        <div style="text-align:center; background-color: #fbfbfb; border-radius: 8px; padding:20px;margin-bottom:20px">
                            <p>Please make a bank transfer with the content clearly stated<br>
                                <b>Name & Phone Number of person</b> receiving goods:<br>
                                Example: <b>A THANH 09888888888</b></p>
                        </div>
                        ...
                        <div style="border: 2px solid #fbfbfb; padding: 10px; border-radius:10px;margin-top:10px">
                            <p style="line-height: 3;">
                                <b>MB BANK - Military Commercial Bank</b> <br>
                                Account holder: NGUYEN HUU HAO <br>
                                Account number: <b>0347603XXX</b> <br>
                            </p>
                        </div>
                    </div>
                </div>
			...
			$(this).on('click', function(e){
                ...
                swal({
                    title: "Product added to cart",
                         text: "You can continue shopping or go to the shopping cart to proceed to checkout",
                        icon: "success",
        ...
        $.ajax({
          ...
          success: function(res)
            ...
            for(var pro of res){
                ...
                _html += '<img class="media-object" width="50" src="'+pro.image+'>'; 
                _html += '</a>'; 
