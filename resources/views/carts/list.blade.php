										...
										<tr class="table_row">
											<td class="column-1">
												<div class="how-itemcart1">
													<img class="b-r-15-new img-sc" src="{{$product->image}}" alt="IMG">
												</div>
											</td>
						...
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="panel panel-default">
								<div class="panel-heading" style="background-color: #333;">
									<h4 style="color: white;"><b>Choose payment method</b></h4>
								</div>
								<div class="panel-body" style="font-size: 12px;">
									<div class="form-group cheque">
										<div class="ps-radio">
											...
											<label for="rdo01">
												<img src="/template/images/icons/thanh-toan-khi-nhan-hang.PNG" alt="#">Tpayment on delivery
											</label>
										</div>
									</div>
									<div class="form-group paypal">
										<div class="ps-radio ps-radio--inline">
											<input type="radio" id="rdo01" name="payment" value="Thanh toán bằng paypal" checked>
											<label for="rdo02">
<img style="max-height: 40px; max-width: 40px; width: auto; height: auto;" src="/template/images/icons/thanh-toan-online.PNG" alt="#"> <a href="{{ route('paypal.checkout') }}">Pay by Paypal</a>
