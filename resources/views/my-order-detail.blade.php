...
<!-- Breadcrumbs -->
	...
	<div class="row gutters-sm pt-45 pl-60 pr-60 pb-80">
        <div class="col-md-3 mb-4">
            ...
            <div class="col-md-9">
            	<h3 style="margin: 20px 0px;">Chi tiết đơn hàng #{{$order->id}} <p style="float:right;">Order date: {{date("h:i d/m/Y", strtotime($order->created_at))}} </p></h3>
				<input type="text" class="OrderId" value="{{$order->id}}" hidden>
				<div class="row">
					<div class="col-sm-4">
						<div class="card panel-default">
							<div class="panel-heading mt-3 ml-3" style="background-color: white;"><h5><b>RECEIVER'S ADDRESS</b></h5></div>
                            <hr>
					...
					<div class="col-sm-4">
						<div class="card panel-default">
							<div class="panel-heading mt-3 ml-3" style="background-color: white;"><h5><b>PAYMENTS</b></h5></div>
                            <hr>
							<div class="panel-body ml-3" style="height:200px">
								<p>Pay on Delivery</p>
...
<th scope="col" style="text-align: right;"><b>Temporary</b></th>
							  </tr>
							</thead>
							<tbody>
...
<p>Total</p>
				...
				<!--  -->
				<!--  -->
				<p><a href="/my-orders" style="text-decoration:none"><< Back to my order</a></p>
			</div>
            </div>
        </div>
	<!--/ End Contact -->
